        ...
        <div>
            <div class="help-info">
                ...
                <ul>
                    ...
                    <li><p>Use the navbar buttons to visualize algorithms and to do other interesting stuffs! There is also a Reset Dropdown Button which allows you to erase the inimation, or the walls and weights or even everything from the grid. There exists another button which controls the speed of the imanition.</p></li>
                </ul>
